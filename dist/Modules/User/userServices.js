...
const createAdminIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield tx.profile.create({ data: profileData });
        return user;
    }));
    return result;
});
...
const myProfileFromDB = (user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const profileData = yield Prisma_1.default.profile.findUniqueOrThrow({
        where: {
...
const profileUpdateFromDB = (user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const userData = yield Prisma_1.default.user.findUniqueOrThrow({
        where: {
            email: user.email,
            status: client_1.UserStatus.ACTIVE,
...
const roleChangeUser = (id, role) => __awaiter(void 0, void 0, void 0, function* () {
